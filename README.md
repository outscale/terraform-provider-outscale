...
$ git clone --branch v0.3.1 https://github.com/outscale-dev/terraform-provider-outscale
```
...
$ go build -o terraform-provider-outscale_v0.3.1
```

Using the provider
----------------------
1. Download and install [Terraform](https://www.terraform.io/downloads.html)
2. Move the plugin to the repository ~/.terraform/plugins/registry.terraform.io/outscale-dev/outscale/0.3.1/linux_amd64/.

```shell
  $ mv terraform-provider-outscale_v0.3.1 ~/.terraform/plugins/registry.terraform.io/outscale-dev/outscale/0.3.1/linux_amd64/.
```
