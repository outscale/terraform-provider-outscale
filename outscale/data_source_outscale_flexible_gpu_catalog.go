...
func dataSourceFlexibleGpuCatalog() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceFlexibleGpuCatalogRead,
...
func dataSourceFlexibleGpuCatalogRead(d *schema.ResourceData, meta interface{}) error {
