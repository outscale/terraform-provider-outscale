...
func TestAccOutscaleDSDirectLinkInterfaces_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDSDxPrivateVirtualInterfacesConfig(connectionID, vifName, bgpAsn),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckOutscaleDSDirectLinkInterfacesExists("data.outscale_directlink_interfaces.outscale_directlink_interfaces"),
...
func testAccCheckOutscaleDSDirectLinkInterfacesExists(name string) resource.TestCheckFunc {
...
func testAccDSDxPrivateVirtualInterfacesConfig(cid, n string, bgpAsn int) string {
	return fmt.Sprintf(`
