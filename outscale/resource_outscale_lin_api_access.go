...
func vpcEndpointStateRefresh(conn *fcu.Client, vpceID string) resource.StateRefreshFunc {
...
func vpcEndpointWaitUntilAvailable(d *schema.ResourceData, conn *fcu.Client) error {
	stateConf := &resource.StateChangeConf{
...
func vpcEndpointAttributes(d *schema.ResourceData, vpce *fcu.VpcEndpoint, conn *fcu.Client) error {
...
func buildFCUAttributeFilterList(attrs map[string]string) []*fcu.Filter {
