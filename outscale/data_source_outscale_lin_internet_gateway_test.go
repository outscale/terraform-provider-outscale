...
func TestAccOutscaleLinInternetGatewayDatasource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: testAccCheckOutscaleLinInternetGatewayDatasourceDestroyed,
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccOutscaleLinInternetGatewayDatasourceConfig,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckOutscaleLinInternetGatewayDatasourceExists("outscale_lin_internet_gateway.gateway", &conf),
				),
			},
		},
	})
...
func testAccCheckOutscaleLinInternetGatewayDatasourceExists(n string, res *fcu.InternetGateway) resource.TestCheckFunc {
...
func testAccCheckOutscaleLinInternetGatewayDatasourceDestroyed(s *terraform.State) error {
	conn := testAccProvider.Meta().(*OutscaleClient)
