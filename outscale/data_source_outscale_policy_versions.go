...
func dataSourceOutscalePolicyVersions() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceOutscalePolicyVersionsRead,
...
func dataSourceOutscalePolicyVersionsRead(d *schema.ResourceData, meta interface{}) error {
