...
func resourceOutscaleOAPIPolicyVersion() *schema.Resource {
	return &schema.Resource{
		Create: resourceOutscaleOAPIPolicyVersionUpdate,
		Read:   resourceOutscaleOAPIPolicyVersionRead,
		Delete: resourceOutscaleOAPIPolicyVersionDelete,
...
func resourceOutscaleOAPIPolicyVersionRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceOutscaleOAPIPolicyVersionUpdate(d *schema.ResourceData, meta interface{}) error {
	eimconn := meta.(*OutscaleClient).EIM
...
func resourceOutscaleOAPIPolicyVersionDelete(d *schema.ResourceData, meta interface{}) error {
	eimconn := meta.(*OutscaleClient).EIM
