...
func resourceOutscaleOAPIPolicyGroup() *schema.Resource {
	return &schema.Resource{
		Create: resourceOutscaleOAPIPolicyGroupPut,
		Read:   resourceOutscaleOAPIPolicyGroupRead,
		Delete: resourceOutscaleOAPIPolicyGroupDelete,
...
func resourceOutscaleOAPIPolicyGroupPut(d *schema.ResourceData, meta interface{}) error {
...
func resourceOutscaleOAPIPolicyGroupRead(d *schema.ResourceData, meta interface{}) error {
	eimconn := meta.(*OutscaleClient).EIM

	group, name := resourceOutscaleOAPIPolicyGroupParseID(d.Id())
...
func resourceOutscaleOAPIPolicyGroupDelete(d *schema.ResourceData, meta interface{}) error {
	eimconn := meta.(*OutscaleClient).EIM
...
func resourceOutscaleOAPIPolicyGroupParseID(id string) (groupName, policyName string) {
