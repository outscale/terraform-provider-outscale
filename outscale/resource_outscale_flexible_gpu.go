...
func ResourceOutscaleFlexibleGpu() *schema.Resource {
	return &schema.Resource{
		Create: ResourceOutscaleFlexibleGpuCreate,
		Read:   ResourceOutscaleFlexibleGpuRead,
		Delete: ResourceOutscaleFlexibleGpuDelete,
...
func ResourceOutscaleFlexibleGpuCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return ResourceOutscaleFlexibleGpuRead(d, meta)
}

func ResourceOutscaleFlexibleGpuRead(d *schema.ResourceData, meta interface{}) error {
	conn := meta.(*OutscaleClient).OSCAPI
...
func ResourceOutscaleFlexibleGpuUpdate(d *schema.ResourceData, meta interface{}) error {
	conn := meta.(*OutscaleClient).OSCAPI
...
func ResourceOutscaleFlexibleGpuDelete(d *schema.ResourceData, meta interface{}) error {
	conn := meta.(*OutscaleClient).OSCAPI
