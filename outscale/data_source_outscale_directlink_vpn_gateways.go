...
func dataSourceOutscaleDLVPNGateways() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceOutscaleDLVPNGatewaysRead,
...
func dataSourceOutscaleDLVPNGatewaysRead(d *schema.ResourceData, meta interface{}) error {
