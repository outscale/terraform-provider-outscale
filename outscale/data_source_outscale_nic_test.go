		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckOutscaleENIDataSourceExists("outscale_nic.outscale_nic", &conf),
					testAccCheckOutscaleENIDataSourceAttributes(&conf),
				),
			},
		},
	})
...
func testAccCheckOutscaleENIDataSourceExists(n string, res *fcu.NetworkInterface) resource.TestCheckFunc {
...
func testAccCheckOutscaleENIDataSourceAttributes(conf *fcu.NetworkInterface) resource.TestCheckFunc {
	return func(s *terraform.State) error {
...
func testAccCheckOutscaleENIDataSourceDestroy(s *terraform.State) error {
