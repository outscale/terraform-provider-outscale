...
func DataSourceLinkedPolicies() *schema.Resource {
	return &schema.Resource{
		Read: DataSourceLinkedPoliciesRead,
...
func DataSourceLinkedPoliciesRead(d *schema.ResourceData, meta interface{}) error {
