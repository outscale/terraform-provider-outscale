...
func dataSourceOutscaleOAPIPolicyVersion() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceOutscaleOAPIPolicyVersionRead,
...
func dataSourceOutscaleOAPIPolicyVersionRead(d *schema.ResourceData, meta interface{}) error {
