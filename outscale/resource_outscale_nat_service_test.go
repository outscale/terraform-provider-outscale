...
resource "outscale_route_table_link" "outscale_route_table_link" {
  ...
  depends_on = ["outscale_route_table.outscale_route_table"]
}
...
resource "outscale_route" "outscale_route" {
  ...
  depends_on = ["outscale_route_table_link.outscale_route_table_link", "outscale_internet_service_link.outscale_internet_service_link"]
}
...
resource "outscale_nat_service" "outscale_nat_service" {
  ...
  depends_on = ["'outscale_route_table_link.outscale_route_table_link",outscale_route.outscale_route"]
}
`
