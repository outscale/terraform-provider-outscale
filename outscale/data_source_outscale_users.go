...
func dataSourceOutscaleUsers() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceOutscaleUsersRead,
...
func dataSourceOutscaleUsersRead(d *schema.ResourceData, meta interface{}) error {
	...
	for k, v := range getResp.Users {
		...
		user["arn"] = aws.StringValue(v.Arn)
