...
func TestOutscalePolicyVersionDataSource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccOutscalePolicyVersionDataSourceConfig(rName),
...
func testAccOutscalePolicyVersionDataSourceConfig(r string) string {
