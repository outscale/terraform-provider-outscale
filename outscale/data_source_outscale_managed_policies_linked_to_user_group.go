...
func DataSourceManagedPoliciesLinkedToUserGroup() *schema.Resource {
	return &schema.Resource{
		Read: DataSourceManagedPoliciesLinkedToUserGroupRead,
...
func DataSourceManagedPoliciesLinkedToUserGroupRead(d *schema.ResourceData, meta interface{}) error {
