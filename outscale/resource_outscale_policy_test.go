...
func TestOutscalePolicy_namePrefix(t *testing.T) {
	var out eim.GetPolicyOutput

	resource.Test(t, resource.TestCase{
		PreCheck:     func() { testAccPreCheck(t) },
		Providers:    testAccProviders,
		CheckDestroy: testAccCheckOutscalePolicyDestroy,
...
func testAccCheckOutscalePolicyDestroy(s *terraform.State) error {
...
func testAccCheckOutscalePolicyExists(reso string, res *eim.GetPolicyOutput) resource.TestCheckFunc {
...
func testAccCheckOutscalePolicyGeneratedNamePrefix(resource, prefix string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
...
const testAccOutscalePolicyPrefixNameConfig = `
