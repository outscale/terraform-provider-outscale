		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckOutscaleLBUAttrAttributes(&conf),
				)},
		},
	})
}

func testAccCheckOutscaleLBUAttrAttributes(conf *lbu.LoadBalancerAttributes) resource.TestCheckFunc {
	return func(s *terraform.State) error {

		if *conf.AccessLog.Enabled != true {
