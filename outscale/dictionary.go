...
func init() {
	...
	datasources = Dictionary{
		...
		"oapi": ResourceMap{
			...
			"outscale_oapi_lin_internet_gateway":  datasourceOutscaleOAPILinInternetGateway,
			"outscale_oapi_lin_internet_gateways": datasourceOutscaleOAPILinInternetGateways,
		},
	}
}
