...
func dataSourceOutscaleLoadBalancersRead(d *schema.ResourceData, meta interface{}) error {
	...
	// 	LoadBalancerNames: &lbu.LoadBalancerNamesMember{Member: []*string{aws.String(elbName.(string))}},
	// }
	...
	// }
	// if len(describeResp.LoadBalancerDescriptions.Member) != 1 {
	// 	return fmt.Errorf("Unable to find ELB: %#v", describeResp.LoadBalancerDescriptions)
	// }

	// lb := describeResp.LoadBalancerDescriptions

	// lbs := make([]map[string]interface{}, len(lb.Member))

	// for k, v := range lb.Member {
	// 	l := make(map[string]interface{})

	// 	l["availability_zones_member"] = flattenStringList(v.AvailabilityZones.Member)
	...
	// 	}
	// 	l["instances_member"] = flattenInstances(v.Instances.Member)
	// 	l["listener_descriptions_member"] = flattenListeners(v.ListenerDescriptions.Member)
	// 	l["load_balancer_name"] = aws.StringValue(v.LoadBalancerName)

	// 	policies := make(map[string]interface{})
	// 	if v.Policies != nil {
	// 		app := make([]map[string]interface{}, len(v.Policies.AppCookieStickinessPolicies.Member))
	// 		for k, v := range v.Policies.AppCookieStickinessPolicies.Member {
	...
	// 		vc := make([]map[string]interface{}, len(v.Policies.LBCookieStickinessPolicies.Member))
	// 		for k, v := range v.Policies.LBCookieStickinessPolicies.Member {
	// 			a := make(map[string]interface{})
	// 			a["policy_name"] = aws.StringValue(v.PolicyName)
	// 			vc[k] = a
	// 		}
	// 		policies["lb_cookie_stickiness_policies_member"] = vc
	// 		policies["other_policies_member"] = flattenStringList(v.Policies.OtherPolicies.Member)
	// 	}

	// 	l["policies"] = policies
	// 	l["scheme"] = aws.StringValue(v.Scheme)
	// 	l["security_groups_member"] = flattenStringList(v.SecurityGroups.Member)
	...
	// 	l["subnets_member"] = flattenStringList(v.Subnets.Member)
