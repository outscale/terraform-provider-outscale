...
func TestAccOutscaleOAPILinInternetGateway_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: testAccCheckOutscaleOAPILinInternetGatewayDestroyed,
...
func testAccCheckOutscaleOAPILinInternetGatewayExists(n string, res *fcu.InternetGateway) resource.TestCheckFunc {
...
func testAccCheckOutscaleOAPILinInternetGatewayDestroyed(s *terraform.State) error {
	conn := testAccProvider.Meta().(*OutscaleClient)
