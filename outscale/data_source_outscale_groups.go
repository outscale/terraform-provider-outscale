...
func dataSourceOutscaleOAPIGroups() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceOutscaleOAPIGroupsRead,
...
func dataSourceOutscaleOAPIGroupsRead(d *schema.ResourceData, meta interface{}) error {
