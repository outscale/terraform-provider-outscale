...
func TestAccOutscalePolicyGroupLinkDataSource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccOutscaleDSGroupPolicyAttachConfig(groupName, policyName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckOutscalePolicyGLDataSourceID("data.outscale_policy.policy_ds"),
				),
			},
		},
	})
...
func testAccCheckOutscalePolicyGLDataSourceID(n string) resource.TestCheckFunc {
...
func testAccOutscaleDSGroupPolicyAttachConfig(groupName, policyName string) string {
	return fmt.Sprintf(`
