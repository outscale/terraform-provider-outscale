...
func dataSourceOutscaleOAPIAccount() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceOutscaleOAPIAccountRead,
...
func dataSourceOutscaleOAPIAccountRead(d *schema.ResourceData, meta interface{}) error {
