...
func dataSourceOutscaleLoadBalancerRead(d *schema.ResourceData, meta interface{}) error {
	...
	// 	LoadBalancerNames: &lbu.LoadBalancerNamesMember{[]*string{aws.String(elbName.(string))}},
	// }
	...
	// d.Set("availability_zones_member", flattenStringList(lb.AvailabilityZones.Member))
	...
	// }
	// d.Set("instances_member", flattenInstances(lb.Instances.Member))
	...
	// 	policies["other_policies_member"] = flattenStringList(lb.Policies.OtherPolicies.Member)
	// }
	// d.Set("policies", policies)
	// d.Set("scheme", aws.StringValue(lb.Scheme))
	// d.Set("security_groups_member", flattenStringList(lb.SecurityGroups.Member))
	...
	// d.Set("subnets_member", flattenStringList(lb.Subnets.Member))
