...
func dataSourceOutscalePrefixLists() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceOutscalePrefixListsRead,
...
func dataSourceOutscalePrefixListsRead(d *schema.ResourceData, meta interface{}) error {
