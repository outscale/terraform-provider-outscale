...
func TestAccDataSourceOutscaleVpc_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceOutscaleVpcConfig(cidr, tag),
				Check: resource.ComposeTestCheckFunc(
					testAccDataSourceOutscaleVpcCheck("data.outscale_lin.by_id", cidr, tag),
				),
			},
		},
	})
...
func testAccDataSourceOutscaleVpcCheck(name, cidr, tag string) resource.TestCheckFunc {
...
func testAccDataSourceOutscaleVpcConfig(cidr, tag string) string {
	return fmt.Sprintf(`
