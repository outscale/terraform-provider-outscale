...
func TestAccOutscaleLinInternetGatewaysDatasource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: testAccCheckOutscaleLinInternetGatewaysDatasourceDestroyed,
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccOutscaleLinInternetGatewaysDatasourceConfig,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckOutscaleLinInternetGatewaysDatasourceExists("outscale_lin_internet_gateway.gateway", &conf),
				),
			},
		},
	})
...
func testAccCheckOutscaleLinInternetGatewaysDatasourceExists(n string, res *fcu.InternetGateway) resource.TestCheckFunc {
...
func testAccCheckOutscaleLinInternetGatewaysDatasourceDestroyed(s *terraform.State) error {
	conn := testAccProvider.Meta().(*OutscaleClient)
...
data "outscale_lin_internet_gateways" "test" {
    filter {
