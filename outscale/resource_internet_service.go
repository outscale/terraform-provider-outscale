...
func (r *resourceInternetService) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err := retry.RetryContext(ctx, createTimeout, func() *retry.RetryError {
		rp, httpResp, err := r.Client.InternetServiceApi.CreateInternetService(context.Background()).CreateInternetServiceRequest(createReq).Execute()
		if err != nil {
...
func (r *resourceInternetService) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	resp.Diagnostics.Append(req.State.GetAttribute(ctx, path.Root("internet_service_id"), &resourceId)...)
	if resp.Diagnostics.HasError() {
		return
	}
...
func (r *resourceInternetService) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := retry.RetryContext(ctx, deleteTimeout, func() *retry.RetryError {
		_, httpResp, err := r.Client.InternetServiceApi.DeleteInternetService(context.Background()).DeleteInternetServiceRequest(delReq).Execute()
		if err != nil {
			return utils.CheckThrottling(httpResp, err)
		}
		return nil
