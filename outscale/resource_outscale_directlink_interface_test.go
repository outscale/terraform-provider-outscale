...
func TestAccOutscaleDirectLinkInterface_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: testAccCheckOutscaleDirectLinkInterfaceDestroy,
		Steps: []resource.TestStep{
			{
				Config: testAccDxPrivateVirtualInterfaceConfig(connectionID, vifName, bgpAsn),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckOutscaleDirectLinkInterfaceExists("outscale_directlink_interface.foo"),
...
func testAccCheckOutscaleDirectLinkInterfaceDestroy(s *terraform.State) error {
...
func testAccCheckOutscaleDirectLinkInterfaceExists(name string) resource.TestCheckFunc {
...
func testAccDxPrivateVirtualInterfaceConfig(cid, n string, bgpAsn int) string {
	return fmt.Sprintf(`
