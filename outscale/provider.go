...
func Provider() terraform.ResourceProvider {
	...
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"outscale_internet_service_link":         GetResource(oapi, "outscale_internet_service_link")(),
			...
			"outscale_security_group":                GetResource(oapi, "outscale_security_group")(),
			...
			"outscale_snapshot":                      GetResource(oapi, "outscale_snapshot")(),
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"outscale_security_group":                      GetDatasource(oapi, "outscale_security_group")(),
			"outscale_security_groups":                     GetDatasource(oapi, "outscale_security_groups")(),
			...
			"outscale_keypair":                             GetDatasource(oapi, "outscale_keypair")(),
			"outscale_keypairs":                            GetDatasource(oapi, "outscale_keypairs")(),
			...
			"outscale_internet_services":                   GetDatasource(oapi, "outscale_internet_services")(),
			...
			"outscale_snapshot":                            GetDatasource(oapi, "outscale_snapshot")(),
			"outscale_snapshots":                           GetDatasource(oapi, "outscale_snapshots")(),
