...
func Provider() terraform.ResourceProvider {
	...
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"outscale_net_internet_gateway_link":     GetResource(oapi, "outscale_net_internet_gateway_link")(),
			"outscale_lin_internet_gateway":          GetResource(fcu, "outscale_lin_internet_gateway")(),
			"outscale_net_internet_gateway":          GetResource(oapi, "outscale_net_internet_gateway")(),
