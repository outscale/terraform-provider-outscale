...
func TestAccOutscaleDSEIMServerCertificates_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDSEIMServerCertsConfigFile(rInt, unixFile),
...
func testAccDSEIMServerCertsConfigFile(rInt int, fName string) string {
	return fmt.Sprintf(`
