...
func TestOutscalePolicyVersionsDataSource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccOutscalePolicyVersionsDataSourceConfig(rName),
...
func testAccOutscalePolicyVersionsDataSourceConfig(r string) string {
