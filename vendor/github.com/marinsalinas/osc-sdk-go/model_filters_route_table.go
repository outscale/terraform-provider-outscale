...
// GetLinkRouteTableLinkRouteTableIdsOk returns a tuple with the LinkRouteTableLinkRouteTableIds field value if set, zero value otherwise
...
// GetLinkSubnetIdsOk returns a tuple with the LinkSubnetIds field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetRouteCreationMethodsOk returns a tuple with the RouteCreationMethods field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetRouteGatewayIdsOk returns a tuple with the RouteGatewayIds field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetRouteNatServiceIdsOk returns a tuple with the RouteNatServiceIds field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetRouteNetPeeringIdsOk returns a tuple with the RouteNetPeeringIds field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetRouteStatesOk returns a tuple with the RouteStates field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetRouteVmIdsOk returns a tuple with the RouteVmIds field value if set, zero value otherwise
// and a boolean to check if the value has been set.
