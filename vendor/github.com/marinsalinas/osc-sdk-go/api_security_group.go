...
func (a *SecurityGroupApiService) CreateSecurityGroup(ctx _context.Context, localVarOptionals *CreateSecurityGroupOpts) (CreateSecurityGroupResponse, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/CreateSecurityGroup"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.CreateSecurityGroupRequest.IsSet() {
		localVarOptionalCreateSecurityGroupRequest, localVarOptionalCreateSecurityGroupRequestok := localVarOptionals.CreateSecurityGroupRequest.Value().(CreateSecurityGroupRequest)
		if !localVarOptionalCreateSecurityGroupRequestok {
			return localVarReturnValue, nil, reportError("createSecurityGroupRequest should be CreateSecurityGroupRequest")
		}
		localVarPostBody = &localVarOptionalCreateSecurityGroupRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v CreateSecurityGroupResponse
...
func (a *SecurityGroupApiService) DeleteSecurityGroup(ctx _context.Context, localVarOptionals *DeleteSecurityGroupOpts) (DeleteSecurityGroupResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/DeleteSecurityGroup"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.DeleteSecurityGroupRequest.IsSet() {
		localVarOptionalDeleteSecurityGroupRequest, localVarOptionalDeleteSecurityGroupRequestok := localVarOptionals.DeleteSecurityGroupRequest.Value().(DeleteSecurityGroupRequest)
		if !localVarOptionalDeleteSecurityGroupRequestok {
			return localVarReturnValue, nil, reportError("deleteSecurityGroupRequest should be DeleteSecurityGroupRequest")
		}
		localVarPostBody = &localVarOptionalDeleteSecurityGroupRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v DeleteSecurityGroupResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *SecurityGroupApiService) ReadSecurityGroups(ctx _context.Context, localVarOptionals *ReadSecurityGroupsOpts) (ReadSecurityGroupsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadSecurityGroups"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadSecurityGroupsRequest.IsSet() {
		...
		if !localVarOptionalReadSecurityGroupsRequestok {
			return localVarReturnValue, nil, reportError("readSecurityGroupsRequest should be ReadSecurityGroupsRequest")
		}
		localVarPostBody = &localVarOptionalReadSecurityGroupsRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v ReadSecurityGroupsResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
