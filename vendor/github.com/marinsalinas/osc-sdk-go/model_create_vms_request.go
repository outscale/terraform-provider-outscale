...
type CreateVmsRequest struct {
	...
	// Data or a script used to add a specific configuration to the VM when creating it. If you are not using a command line tool, this must be Base64-encoded.
	...
	// The type of VM (`tinav2.c1r2` by default).<br /> For more information, see [Instance Types](https://wiki.outscale.net/display/EN/Instance+Types).
...
// GetBootOnCreationOk returns a tuple with the BootOnCreation field value if set, zero value otherwise
// and a boolean to check if the value has been set.
