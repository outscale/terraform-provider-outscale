...
// GetQueryAccessKeysOk returns a tuple with the QueryAccessKeys field value if set, zero value otherwise
...
// GetQueryApiNamesOk returns a tuple with the QueryApiNames field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetQueryCallNamesOk returns a tuple with the QueryCallNames field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetQueryDateAfterOk returns a tuple with the QueryDateAfter field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetQueryDateBeforeOk returns a tuple with the QueryDateBefore field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetQueryIpAddressesOk returns a tuple with the QueryIpAddresses field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetQueryUserAgentsOk returns a tuple with the QueryUserAgents field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetRequestIdsOk returns a tuple with the RequestIds field value if set, zero value otherwise
// and a boolean to check if the value has been set.
