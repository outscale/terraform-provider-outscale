...
// GetSecurityGroupAccountIdToLinkOk returns a tuple with the SecurityGroupAccountIdToLink field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetSecurityGroupNameToLinkOk returns a tuple with the SecurityGroupNameToLink field value if set, zero value otherwise
// and a boolean to check if the value has been set.
