...
func (a *VpnConnectionApiService) CreateVpnConnection(ctx _context.Context, localVarOptionals *CreateVpnConnectionOpts) (CreateVpnConnectionResponse, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/CreateVpnConnection"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.CreateVpnConnectionRequest.IsSet() {
		localVarOptionalCreateVpnConnectionRequest, localVarOptionalCreateVpnConnectionRequestok := localVarOptionals.CreateVpnConnectionRequest.Value().(CreateVpnConnectionRequest)
		if !localVarOptionalCreateVpnConnectionRequestok {
			return localVarReturnValue, nil, reportError("createVpnConnectionRequest should be CreateVpnConnectionRequest")
		}
		localVarPostBody = &localVarOptionalCreateVpnConnectionRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v CreateVpnConnectionResponse
...
func (a *VpnConnectionApiService) DeleteVpnConnection(ctx _context.Context, localVarOptionals *DeleteVpnConnectionOpts) (DeleteVpnConnectionResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/DeleteVpnConnection"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.DeleteVpnConnectionRequest.IsSet() {
		localVarOptionalDeleteVpnConnectionRequest, localVarOptionalDeleteVpnConnectionRequestok := localVarOptionals.DeleteVpnConnectionRequest.Value().(DeleteVpnConnectionRequest)
		if !localVarOptionalDeleteVpnConnectionRequestok {
			return localVarReturnValue, nil, reportError("deleteVpnConnectionRequest should be DeleteVpnConnectionRequest")
		}
		localVarPostBody = &localVarOptionalDeleteVpnConnectionRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v DeleteVpnConnectionResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *VpnConnectionApiService) DeleteVpnConnectionRoute(ctx _context.Context, localVarOptionals *DeleteVpnConnectionRouteOpts) (DeleteVpnConnectionRouteResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/DeleteVpnConnectionRoute"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.DeleteVpnConnectionRouteRequest.IsSet() {
		localVarOptionalDeleteVpnConnectionRouteRequest, localVarOptionalDeleteVpnConnectionRouteRequestok := localVarOptionals.DeleteVpnConnectionRouteRequest.Value().(DeleteVpnConnectionRouteRequest)
		if !localVarOptionalDeleteVpnConnectionRouteRequestok {
			return localVarReturnValue, nil, reportError("deleteVpnConnectionRouteRequest should be DeleteVpnConnectionRouteRequest")
		}
		localVarPostBody = &localVarOptionalDeleteVpnConnectionRouteRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v DeleteVpnConnectionRouteResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *VpnConnectionApiService) ReadVpnConnections(ctx _context.Context, localVarOptionals *ReadVpnConnectionsOpts) (ReadVpnConnectionsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadVpnConnections"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadVpnConnectionsRequest.IsSet() {
		localVarOptionalReadVpnConnectionsRequest, localVarOptionalReadVpnConnectionsRequestok := localVarOptionals.ReadVpnConnectionsRequest.Value().(ReadVpnConnectionsRequest)
		if !localVarOptionalReadVpnConnectionsRequestok {
			return localVarReturnValue, nil, reportError("readVpnConnectionsRequest should be ReadVpnConnectionsRequest")
		}
		localVarPostBody = &localVarOptionalReadVpnConnectionsRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v ReadVpnConnectionsResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
