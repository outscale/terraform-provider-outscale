...
// GetClientGatewayConfigurationOk returns a tuple with the ClientGatewayConfiguration field value if set, zero value otherwise
...
// GetClientGatewayIdOk returns a tuple with the ClientGatewayId field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetVpnConnectionIdOk returns a tuple with the VpnConnectionId field value if set, zero value otherwise
// and a boolean to check if the value has been set.
