...
func (a *ServerCertificateApiService) CreateServerCertificate(ctx _context.Context, localVarOptionals *CreateServerCertificateOpts) (CreateServerCertificateResponse, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/CreateServerCertificate"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.CreateServerCertificateRequest.IsSet() {
		localVarOptionalCreateServerCertificateRequest, localVarOptionalCreateServerCertificateRequestok := localVarOptionals.CreateServerCertificateRequest.Value().(CreateServerCertificateRequest)
		if !localVarOptionalCreateServerCertificateRequestok {
			return localVarReturnValue, nil, reportError("createServerCertificateRequest should be CreateServerCertificateRequest")
		}
		localVarPostBody = &localVarOptionalCreateServerCertificateRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v CreateServerCertificateResponse
...
func (a *ServerCertificateApiService) DeleteServerCertificate(ctx _context.Context, localVarOptionals *DeleteServerCertificateOpts) (DeleteServerCertificateResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/DeleteServerCertificate"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.DeleteServerCertificateRequest.IsSet() {
		localVarOptionalDeleteServerCertificateRequest, localVarOptionalDeleteServerCertificateRequestok := localVarOptionals.DeleteServerCertificateRequest.Value().(DeleteServerCertificateRequest)
		if !localVarOptionalDeleteServerCertificateRequestok {
			return localVarReturnValue, nil, reportError("deleteServerCertificateRequest should be DeleteServerCertificateRequest")
		}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v DeleteServerCertificateResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *ServerCertificateApiService) ReadServerCertificates(ctx _context.Context, localVarOptionals *ReadServerCertificatesOpts) (ReadServerCertificatesResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadServerCertificates"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadServerCertificatesRequest.IsSet() {
		localVarOptionalReadServerCertificatesRequest, localVarOptionalReadServerCertificatesRequestok := localVarOptionals.ReadServerCertificatesRequest.Value().(ReadServerCertificatesRequest)
		if !localVarOptionalReadServerCertificatesRequestok {
			return localVarReturnValue, nil, reportError("readServerCertificatesRequest should be ReadServerCertificatesRequest")
		}
		localVarPostBody = &localVarOptionalReadServerCertificatesRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v ReadServerCertificatesResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *ServerCertificateApiService) UpdateServerCertificate(ctx _context.Context, localVarOptionals *UpdateServerCertificateOpts) (UpdateServerCertificateResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/UpdateServerCertificate"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.UpdateServerCertificateRequest.IsSet() {
		localVarOptionalUpdateServerCertificateRequest, localVarOptionalUpdateServerCertificateRequestok := localVarOptionals.UpdateServerCertificateRequest.Value().(UpdateServerCertificateRequest)
		if !localVarOptionalUpdateServerCertificateRequestok {
			return localVarReturnValue, nil, reportError("updateServerCertificateRequest should be UpdateServerCertificateRequest")
		}
		localVarPostBody = &localVarOptionalUpdateServerCertificateRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v UpdateServerCertificateResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
