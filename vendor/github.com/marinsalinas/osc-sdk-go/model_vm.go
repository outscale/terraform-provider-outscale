...
type Vm struct {
	...
	// The VM behavior when you stop it. By default or if set to `stop`, the VM stops. If set to `restart`, the VM stops then automatically restarts. If set to `delete`, the VM stops and is deleted.
...
// GetClientTokenOk returns a tuple with the ClientToken field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetHypervisorOk returns a tuple with the Hypervisor field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetOsFamilyOk returns a tuple with the OsFamily field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetPlacementOk returns a tuple with the Placement field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetReservationIdOk returns a tuple with the ReservationId field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetStateReasonOk returns a tuple with the StateReason field value if set, zero value otherwise
// and a boolean to check if the value has been set.
