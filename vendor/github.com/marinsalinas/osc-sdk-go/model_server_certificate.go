...
// GetExpirationDateOk returns a tuple with the ExpirationDate field value if set, zero value otherwise
...
// GetUploadDateOk returns a tuple with the UploadDate field value if set, zero value otherwise
// and a boolean to check if the value has been set.
