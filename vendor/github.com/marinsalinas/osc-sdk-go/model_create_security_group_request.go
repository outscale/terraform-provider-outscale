...
type CreateSecurityGroupRequest struct {
	...
	// (Public Cloud only) The name of the security group.<br /> This name must be unique and contain between 1 and 255 ASCII characters. Accented letters are not allowed.
