...
type ReadRegionsOpts struct {
	ReadRegionsRequest optional.Interface
}
...
func (a *RegionApiService) ReadRegions(ctx _context.Context, localVarOptionals *ReadRegionsOpts) (ReadRegionsResponse, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/ReadRegions"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadRegionsRequest.IsSet() {
		localVarOptionalReadRegionsRequest, localVarOptionalReadRegionsRequestok := localVarOptionals.ReadRegionsRequest.Value().(ReadRegionsRequest)
		if !localVarOptionalReadRegionsRequestok {
			return localVarReturnValue, nil, reportError("readRegionsRequest should be ReadRegionsRequest")
		}
		localVarPostBody = &localVarOptionalReadRegionsRequest
	}
