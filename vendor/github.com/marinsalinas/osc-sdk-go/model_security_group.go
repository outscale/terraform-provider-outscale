...
// GetInboundRulesOk returns a tuple with the InboundRules field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetOutboundRulesOk returns a tuple with the OutboundRules field value if set, zero value otherwise
// and a boolean to check if the value has been set.
