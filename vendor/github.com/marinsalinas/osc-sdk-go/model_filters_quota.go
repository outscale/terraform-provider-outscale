...
// GetQuotaNamesOk returns a tuple with the QuotaNames field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetShortDescriptionsOk returns a tuple with the ShortDescriptions field value if set, zero value otherwise
// and a boolean to check if the value has been set.
