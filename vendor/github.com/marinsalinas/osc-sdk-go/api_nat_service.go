...
func (a *NatServiceApiService) CreateNatService(ctx _context.Context, localVarOptionals *CreateNatServiceOpts) (CreateNatServiceResponse, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/CreateNatService"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.CreateNatServiceRequest.IsSet() {
		localVarOptionalCreateNatServiceRequest, localVarOptionalCreateNatServiceRequestok := localVarOptionals.CreateNatServiceRequest.Value().(CreateNatServiceRequest)
		if !localVarOptionalCreateNatServiceRequestok {
			return localVarReturnValue, nil, reportError("createNatServiceRequest should be CreateNatServiceRequest")
		}
		localVarPostBody = &localVarOptionalCreateNatServiceRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v CreateNatServiceResponse
...
func (a *NatServiceApiService) DeleteNatService(ctx _context.Context, localVarOptionals *DeleteNatServiceOpts) (DeleteNatServiceResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/DeleteNatService"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.DeleteNatServiceRequest.IsSet() {
		localVarOptionalDeleteNatServiceRequest, localVarOptionalDeleteNatServiceRequestok := localVarOptionals.DeleteNatServiceRequest.Value().(DeleteNatServiceRequest)
		if !localVarOptionalDeleteNatServiceRequestok {
			return localVarReturnValue, nil, reportError("deleteNatServiceRequest should be DeleteNatServiceRequest")
		}
		localVarPostBody = &localVarOptionalDeleteNatServiceRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v DeleteNatServiceResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *NatServiceApiService) ReadNatServices(ctx _context.Context, localVarOptionals *ReadNatServicesOpts) (ReadNatServicesResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadNatServices"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadNatServicesRequest.IsSet() {
		localVarOptionalReadNatServicesRequest, localVarOptionalReadNatServicesRequestok := localVarOptionals.ReadNatServicesRequest.Value().(ReadNatServicesRequest)
		if !localVarOptionalReadNatServicesRequestok {
			return localVarReturnValue, nil, reportError("readNatServicesRequest should be ReadNatServicesRequest")
		}
		localVarPostBody = &localVarOptionalReadNatServicesRequest
	}
