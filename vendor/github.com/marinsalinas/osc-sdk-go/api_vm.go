...
func (a *VmApiService) CreateVms(ctx _context.Context, localVarOptionals *CreateVmsOpts) (CreateVmsResponse, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/CreateVms"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.CreateVmsRequest.IsSet() {
		localVarOptionalCreateVmsRequest, localVarOptionalCreateVmsRequestok := localVarOptionals.CreateVmsRequest.Value().(CreateVmsRequest)
		if !localVarOptionalCreateVmsRequestok {
			return localVarReturnValue, nil, reportError("createVmsRequest should be CreateVmsRequest")
		}
		localVarPostBody = &localVarOptionalCreateVmsRequest
	}
...
func (a *VmApiService) DeleteVms(ctx _context.Context, localVarOptionals *DeleteVmsOpts) (DeleteVmsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/DeleteVms"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.DeleteVmsRequest.IsSet() {
		localVarOptionalDeleteVmsRequest, localVarOptionalDeleteVmsRequestok := localVarOptionals.DeleteVmsRequest.Value().(DeleteVmsRequest)
		if !localVarOptionalDeleteVmsRequestok {
			return localVarReturnValue, nil, reportError("deleteVmsRequest should be DeleteVmsRequest")
		}
		localVarPostBody = &localVarOptionalDeleteVmsRequest
	}
...
func (a *VmApiService) ReadAdminPassword(ctx _context.Context, localVarOptionals *ReadAdminPasswordOpts) (ReadAdminPasswordResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadAdminPassword"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadAdminPasswordRequest.IsSet() {
		localVarOptionalReadAdminPasswordRequest, localVarOptionalReadAdminPasswordRequestok := localVarOptionals.ReadAdminPasswordRequest.Value().(ReadAdminPasswordRequest)
		if !localVarOptionalReadAdminPasswordRequestok {
			return localVarReturnValue, nil, reportError("readAdminPasswordRequest should be ReadAdminPasswordRequest")
		}
		localVarPostBody = &localVarOptionalReadAdminPasswordRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v ReadAdminPasswordResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *VmApiService) ReadConsoleOutput(ctx _context.Context, localVarOptionals *ReadConsoleOutputOpts) (ReadConsoleOutputResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadConsoleOutput"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadConsoleOutputRequest.IsSet() {
		localVarOptionalReadConsoleOutputRequest, localVarOptionalReadConsoleOutputRequestok := localVarOptionals.ReadConsoleOutputRequest.Value().(ReadConsoleOutputRequest)
		if !localVarOptionalReadConsoleOutputRequestok {
			return localVarReturnValue, nil, reportError("readConsoleOutputRequest should be ReadConsoleOutputRequest")
		}
		localVarPostBody = &localVarOptionalReadConsoleOutputRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v ReadConsoleOutputResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *VmApiService) ReadVmTypes(ctx _context.Context, localVarOptionals *ReadVmTypesOpts) (ReadVmTypesResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadVmTypes"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadVmTypesRequest.IsSet() {
		localVarOptionalReadVmTypesRequest, localVarOptionalReadVmTypesRequestok := localVarOptionals.ReadVmTypesRequest.Value().(ReadVmTypesRequest)
		if !localVarOptionalReadVmTypesRequestok {
			return localVarReturnValue, nil, reportError("readVmTypesRequest should be ReadVmTypesRequest")
		}
		localVarPostBody = &localVarOptionalReadVmTypesRequest
	}
...
func (a *VmApiService) ReadVms(ctx _context.Context, localVarOptionals *ReadVmsOpts) (ReadVmsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadVms"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadVmsRequest.IsSet() {
		localVarOptionalReadVmsRequest, localVarOptionalReadVmsRequestok := localVarOptionals.ReadVmsRequest.Value().(ReadVmsRequest)
		if !localVarOptionalReadVmsRequestok {
			return localVarReturnValue, nil, reportError("readVmsRequest should be ReadVmsRequest")
		}
		localVarPostBody = &localVarOptionalReadVmsRequest
	}
...
func (a *VmApiService) ReadVmsState(ctx _context.Context, localVarOptionals *ReadVmsStateOpts) (ReadVmsStateResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadVmsState"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadVmsStateRequest.IsSet() {
		localVarOptionalReadVmsStateRequest, localVarOptionalReadVmsStateRequestok := localVarOptionals.ReadVmsStateRequest.Value().(ReadVmsStateRequest)
		if !localVarOptionalReadVmsStateRequestok {
			return localVarReturnValue, nil, reportError("readVmsStateRequest should be ReadVmsStateRequest")
		}
		localVarPostBody = &localVarOptionalReadVmsStateRequest
	}
...
func (a *VmApiService) RebootVms(ctx _context.Context, localVarOptionals *RebootVmsOpts) (RebootVmsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/RebootVms"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.RebootVmsRequest.IsSet() {
		localVarOptionalRebootVmsRequest, localVarOptionalRebootVmsRequestok := localVarOptionals.RebootVmsRequest.Value().(RebootVmsRequest)
		if !localVarOptionalRebootVmsRequestok {
			return localVarReturnValue, nil, reportError("rebootVmsRequest should be RebootVmsRequest")
		}
		localVarPostBody = &localVarOptionalRebootVmsRequest
	}
...
func (a *VmApiService) StartVms(ctx _context.Context, localVarOptionals *StartVmsOpts) (StartVmsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/StartVms"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.StartVmsRequest.IsSet() {
		localVarOptionalStartVmsRequest, localVarOptionalStartVmsRequestok := localVarOptionals.StartVmsRequest.Value().(StartVmsRequest)
		if !localVarOptionalStartVmsRequestok {
			return localVarReturnValue, nil, reportError("startVmsRequest should be StartVmsRequest")
		}
		localVarPostBody = &localVarOptionalStartVmsRequest
	}
...
func (a *VmApiService) StopVms(ctx _context.Context, localVarOptionals *StopVmsOpts) (StopVmsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/StopVms"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.StopVmsRequest.IsSet() {
		localVarOptionalStopVmsRequest, localVarOptionalStopVmsRequestok := localVarOptionals.StopVmsRequest.Value().(StopVmsRequest)
		if !localVarOptionalStopVmsRequestok {
			return localVarReturnValue, nil, reportError("stopVmsRequest should be StopVmsRequest")
		}
		localVarPostBody = &localVarOptionalStopVmsRequest
	}
...
func (a *VmApiService) UpdateVm(ctx _context.Context, localVarOptionals *UpdateVmOpts) (UpdateVmResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/UpdateVm"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.UpdateVmRequest.IsSet() {
		localVarOptionalUpdateVmRequest, localVarOptionalUpdateVmRequestok := localVarOptionals.UpdateVmRequest.Value().(UpdateVmRequest)
		if !localVarOptionalUpdateVmRequestok {
			return localVarReturnValue, nil, reportError("updateVmRequest should be UpdateVmRequest")
		}
		localVarPostBody = &localVarOptionalUpdateVmRequest
	}
