...
func (a *NetApiService) CreateNet(ctx _context.Context, localVarOptionals *CreateNetOpts) (CreateNetResponse, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/CreateNet"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.CreateNetRequest.IsSet() {
		localVarOptionalCreateNetRequest, localVarOptionalCreateNetRequestok := localVarOptionals.CreateNetRequest.Value().(CreateNetRequest)
		if !localVarOptionalCreateNetRequestok {
			return localVarReturnValue, nil, reportError("createNetRequest should be CreateNetRequest")
		}
		localVarPostBody = &localVarOptionalCreateNetRequest
	}
...
func (a *NetApiService) DeleteNet(ctx _context.Context, localVarOptionals *DeleteNetOpts) (DeleteNetResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/DeleteNet"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.DeleteNetRequest.IsSet() {
		localVarOptionalDeleteNetRequest, localVarOptionalDeleteNetRequestok := localVarOptionals.DeleteNetRequest.Value().(DeleteNetRequest)
		if !localVarOptionalDeleteNetRequestok {
			return localVarReturnValue, nil, reportError("deleteNetRequest should be DeleteNetRequest")
		}
		localVarPostBody = &localVarOptionalDeleteNetRequest
	}
...
func (a *NetApiService) ReadNets(ctx _context.Context, localVarOptionals *ReadNetsOpts) (ReadNetsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadNets"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadNetsRequest.IsSet() {
		localVarOptionalReadNetsRequest, localVarOptionalReadNetsRequestok := localVarOptionals.ReadNetsRequest.Value().(ReadNetsRequest)
		if !localVarOptionalReadNetsRequestok {
			return localVarReturnValue, nil, reportError("readNetsRequest should be ReadNetsRequest")
		}
		localVarPostBody = &localVarOptionalReadNetsRequest
	}
...
func (a *NetApiService) UpdateNet(ctx _context.Context, localVarOptionals *UpdateNetOpts) (UpdateNetResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/UpdateNet"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.UpdateNetRequest.IsSet() {
		localVarOptionalUpdateNetRequest, localVarOptionalUpdateNetRequestok := localVarOptionals.UpdateNetRequest.Value().(UpdateNetRequest)
		if !localVarOptionalUpdateNetRequestok {
			return localVarReturnValue, nil, reportError("updateNetRequest should be UpdateNetRequest")
		}
		localVarPostBody = &localVarOptionalUpdateNetRequest
	}
