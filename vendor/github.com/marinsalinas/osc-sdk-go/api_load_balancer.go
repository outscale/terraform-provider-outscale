...
func (a *LoadBalancerApiService) CreateLoadBalancerTags(ctx _context.Context, localVarOptionals *CreateLoadBalancerTagsOpts) (CreateLoadBalancerTagsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/CreateLoadBalancerTags"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.CreateLoadBalancerTagsRequest.IsSet() {
		localVarOptionalCreateLoadBalancerTagsRequest, localVarOptionalCreateLoadBalancerTagsRequestok := localVarOptionals.CreateLoadBalancerTagsRequest.Value().(CreateLoadBalancerTagsRequest)
		if !localVarOptionalCreateLoadBalancerTagsRequestok {
			return localVarReturnValue, nil, reportError("createLoadBalancerTagsRequest should be CreateLoadBalancerTagsRequest")
		}
		localVarPostBody = &localVarOptionalCreateLoadBalancerTagsRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v CreateLoadBalancerTagsResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *LoadBalancerApiService) DeleteLoadBalancerTags(ctx _context.Context, localVarOptionals *DeleteLoadBalancerTagsOpts) (DeleteLoadBalancerTagsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/DeleteLoadBalancerTags"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.DeleteLoadBalancerTagsRequest.IsSet() {
		localVarOptionalDeleteLoadBalancerTagsRequest, localVarOptionalDeleteLoadBalancerTagsRequestok := localVarOptionals.DeleteLoadBalancerTagsRequest.Value().(DeleteLoadBalancerTagsRequest)
		if !localVarOptionalDeleteLoadBalancerTagsRequestok {
			return localVarReturnValue, nil, reportError("deleteLoadBalancerTagsRequest should be DeleteLoadBalancerTagsRequest")
		}
		localVarPostBody = &localVarOptionalDeleteLoadBalancerTagsRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v DeleteLoadBalancerTagsResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *LoadBalancerApiService) ReadLoadBalancerTags(ctx _context.Context, localVarOptionals *ReadLoadBalancerTagsOpts) (ReadLoadBalancerTagsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadLoadBalancerTags"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadLoadBalancerTagsRequest.IsSet() {
		localVarOptionalReadLoadBalancerTagsRequest, localVarOptionalReadLoadBalancerTagsRequestok := localVarOptionals.ReadLoadBalancerTagsRequest.Value().(ReadLoadBalancerTagsRequest)
		if !localVarOptionalReadLoadBalancerTagsRequestok {
			return localVarReturnValue, nil, reportError("readLoadBalancerTagsRequest should be ReadLoadBalancerTagsRequest")
		}
		localVarPostBody = &localVarOptionalReadLoadBalancerTagsRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v ReadLoadBalancerTagsResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *LoadBalancerApiService) ReadVmsHealth(ctx _context.Context, localVarOptionals *ReadVmsHealthOpts) (ReadVmsHealthResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadVmsHealth"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadVmsHealthRequest.IsSet() {
		localVarOptionalReadVmsHealthRequest, localVarOptionalReadVmsHealthRequestok := localVarOptionals.ReadVmsHealthRequest.Value().(ReadVmsHealthRequest)
		if !localVarOptionalReadVmsHealthRequestok {
			return localVarReturnValue, nil, reportError("readVmsHealthRequest should be ReadVmsHealthRequest")
		}
		localVarPostBody = &localVarOptionalReadVmsHealthRequest
	}
