...
// GetOsuBucketNameOk returns a tuple with the OsuBucketName field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetOsuBucketPrefixOk returns a tuple with the OsuBucketPrefix field value if set, zero value otherwise
// and a boolean to check if the value has been set.
