...
func (a *NetPeeringApiService) AcceptNetPeering(ctx _context.Context, localVarOptionals *AcceptNetPeeringOpts) (AcceptNetPeeringResponse, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/AcceptNetPeering"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.AcceptNetPeeringRequest.IsSet() {
		localVarOptionalAcceptNetPeeringRequest, localVarOptionalAcceptNetPeeringRequestok := localVarOptionals.AcceptNetPeeringRequest.Value().(AcceptNetPeeringRequest)
		if !localVarOptionalAcceptNetPeeringRequestok {
			return localVarReturnValue, nil, reportError("acceptNetPeeringRequest should be AcceptNetPeeringRequest")
		}
		localVarPostBody = &localVarOptionalAcceptNetPeeringRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v AcceptNetPeeringResponse
...
func (a *NetPeeringApiService) CreateNetPeering(ctx _context.Context, localVarOptionals *CreateNetPeeringOpts) (CreateNetPeeringResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/CreateNetPeering"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.CreateNetPeeringRequest.IsSet() {
		localVarOptionalCreateNetPeeringRequest, localVarOptionalCreateNetPeeringRequestok := localVarOptionals.CreateNetPeeringRequest.Value().(CreateNetPeeringRequest)
		if !localVarOptionalCreateNetPeeringRequestok {
			return localVarReturnValue, nil, reportError("createNetPeeringRequest should be CreateNetPeeringRequest")
		}
		localVarPostBody = &localVarOptionalCreateNetPeeringRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v CreateNetPeeringResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *NetPeeringApiService) DeleteNetPeering(ctx _context.Context, localVarOptionals *DeleteNetPeeringOpts) (DeleteNetPeeringResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/DeleteNetPeering"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.DeleteNetPeeringRequest.IsSet() {
		localVarOptionalDeleteNetPeeringRequest, localVarOptionalDeleteNetPeeringRequestok := localVarOptionals.DeleteNetPeeringRequest.Value().(DeleteNetPeeringRequest)
		if !localVarOptionalDeleteNetPeeringRequestok {
			return localVarReturnValue, nil, reportError("deleteNetPeeringRequest should be DeleteNetPeeringRequest")
		}
		localVarPostBody = &localVarOptionalDeleteNetPeeringRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v DeleteNetPeeringResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *NetPeeringApiService) ReadNetPeerings(ctx _context.Context, localVarOptionals *ReadNetPeeringsOpts) (ReadNetPeeringsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadNetPeerings"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadNetPeeringsRequest.IsSet() {
		localVarOptionalReadNetPeeringsRequest, localVarOptionalReadNetPeeringsRequestok := localVarOptionals.ReadNetPeeringsRequest.Value().(ReadNetPeeringsRequest)
		if !localVarOptionalReadNetPeeringsRequestok {
			return localVarReturnValue, nil, reportError("readNetPeeringsRequest should be ReadNetPeeringsRequest")
		}
		localVarPostBody = &localVarOptionalReadNetPeeringsRequest
	}
...
func (a *NetPeeringApiService) RejectNetPeering(ctx _context.Context, localVarOptionals *RejectNetPeeringOpts) (RejectNetPeeringResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/RejectNetPeering"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.RejectNetPeeringRequest.IsSet() {
		localVarOptionalRejectNetPeeringRequest, localVarOptionalRejectNetPeeringRequestok := localVarOptionals.RejectNetPeeringRequest.Value().(RejectNetPeeringRequest)
		if !localVarOptionalRejectNetPeeringRequestok {
			return localVarReturnValue, nil, reportError("rejectNetPeeringRequest should be RejectNetPeeringRequest")
		}
		localVarPostBody = &localVarOptionalRejectNetPeeringRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v RejectNetPeeringResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
