...
// GetRulesOk returns a tuple with the Rules field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetSecurityGroupAccountIdToUnlinkOk returns a tuple with the SecurityGroupAccountIdToUnlink field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetSecurityGroupNameToUnlinkOk returns a tuple with the SecurityGroupNameToUnlink field value if set, zero value otherwise
// and a boolean to check if the value has been set.
