...
func (a *NicApiService) LinkPrivateIps(ctx _context.Context, localVarOptionals *LinkPrivateIpsOpts) (LinkPrivateIpsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/LinkPrivateIps"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.LinkPrivateIpsRequest.IsSet() {
		localVarOptionalLinkPrivateIpsRequest, localVarOptionalLinkPrivateIpsRequestok := localVarOptionals.LinkPrivateIpsRequest.Value().(LinkPrivateIpsRequest)
		if !localVarOptionalLinkPrivateIpsRequestok {
			return localVarReturnValue, nil, reportError("linkPrivateIpsRequest should be LinkPrivateIpsRequest")
		}
		localVarPostBody = &localVarOptionalLinkPrivateIpsRequest
	}
...
func (a *NicApiService) UnlinkNic(ctx _context.Context, localVarOptionals *UnlinkNicOpts) (UnlinkNicResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/UnlinkNic"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.UnlinkNicRequest.IsSet() {
		localVarOptionalUnlinkNicRequest, localVarOptionalUnlinkNicRequestok := localVarOptionals.UnlinkNicRequest.Value().(UnlinkNicRequest)
		if !localVarOptionalUnlinkNicRequestok {
			return localVarReturnValue, nil, reportError("unlinkNicRequest should be UnlinkNicRequest")
		}
		localVarPostBody = &localVarOptionalUnlinkNicRequest
	}
...
func (a *NicApiService) UnlinkPrivateIps(ctx _context.Context, localVarOptionals *UnlinkPrivateIpsOpts) (UnlinkPrivateIpsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/UnlinkPrivateIps"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.UnlinkPrivateIpsRequest.IsSet() {
		localVarOptionalUnlinkPrivateIpsRequest, localVarOptionalUnlinkPrivateIpsRequestok := localVarOptionals.UnlinkPrivateIpsRequest.Value().(UnlinkPrivateIpsRequest)
		if !localVarOptionalUnlinkPrivateIpsRequestok {
			return localVarReturnValue, nil, reportError("unlinkPrivateIpsRequest should be UnlinkPrivateIpsRequest")
		}
		localVarPostBody = &localVarOptionalUnlinkPrivateIpsRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v UnlinkPrivateIpsResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
