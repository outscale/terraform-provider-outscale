...
func (a *PublicIpApiService) CreatePublicIp(ctx _context.Context, localVarOptionals *CreatePublicIpOpts) (CreatePublicIpResponse, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/CreatePublicIp"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.CreatePublicIpRequest.IsSet() {
		localVarOptionalCreatePublicIpRequest, localVarOptionalCreatePublicIpRequestok := localVarOptionals.CreatePublicIpRequest.Value().(CreatePublicIpRequest)
		if !localVarOptionalCreatePublicIpRequestok {
			return localVarReturnValue, nil, reportError("createPublicIpRequest should be CreatePublicIpRequest")
		}
...
func (a *PublicIpApiService) DeletePublicIp(ctx _context.Context, localVarOptionals *DeletePublicIpOpts) (DeletePublicIpResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/DeletePublicIp"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.DeletePublicIpRequest.IsSet() {
		localVarOptionalDeletePublicIpRequest, localVarOptionalDeletePublicIpRequestok := localVarOptionals.DeletePublicIpRequest.Value().(DeletePublicIpRequest)
		if !localVarOptionalDeletePublicIpRequestok {
			return localVarReturnValue, nil, reportError("deletePublicIpRequest should be DeletePublicIpRequest")
		}
		localVarPostBody = &localVarOptionalDeletePublicIpRequest
	}
...
func (a *PublicIpApiService) LinkPublicIp(ctx _context.Context, localVarOptionals *LinkPublicIpOpts) (LinkPublicIpResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/LinkPublicIp"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.LinkPublicIpRequest.IsSet() {
		localVarOptionalLinkPublicIpRequest, localVarOptionalLinkPublicIpRequestok := localVarOptionals.LinkPublicIpRequest.Value().(LinkPublicIpRequest)
		if !localVarOptionalLinkPublicIpRequestok {
			return localVarReturnValue, nil, reportError("linkPublicIpRequest should be LinkPublicIpRequest")
		}
		localVarPostBody = &localVarOptionalLinkPublicIpRequest
	}
...
func (a *PublicIpApiService) ReadPublicIps(ctx _context.Context, localVarOptionals *ReadPublicIpsOpts) (ReadPublicIpsResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ReadPublicIps"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadPublicIpsRequest.IsSet() {
		localVarOptionalReadPublicIpsRequest, localVarOptionalReadPublicIpsRequestok := localVarOptionals.ReadPublicIpsRequest.Value().(ReadPublicIpsRequest)
		if !localVarOptionalReadPublicIpsRequestok {
			return localVarReturnValue, nil, reportError("readPublicIpsRequest should be ReadPublicIpsRequest")
		}
		localVarPostBody = &localVarOptionalReadPublicIpsRequest
	}
...
func (a *PublicIpApiService) UnlinkPublicIp(ctx _context.Context, localVarOptionals *UnlinkPublicIpOpts) (UnlinkPublicIpResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/UnlinkPublicIp"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.UnlinkPublicIpRequest.IsSet() {
		localVarOptionalUnlinkPublicIpRequest, localVarOptionalUnlinkPublicIpRequestok := localVarOptionals.UnlinkPublicIpRequest.Value().(UnlinkPublicIpRequest)
		if !localVarOptionalUnlinkPublicIpRequestok {
			return localVarReturnValue, nil, reportError("unlinkPublicIpRequest should be UnlinkPublicIpRequest")
		}
		localVarPostBody = &localVarOptionalUnlinkPublicIpRequest
	}
