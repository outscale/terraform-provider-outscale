...
func (a *SubregionApiService) ReadSubregions(ctx _context.Context, localVarOptionals *ReadSubregionsOpts) (ReadSubregionsResponse, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/ReadSubregions"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ReadSubregionsRequest.IsSet() {
		localVarOptionalReadSubregionsRequest, localVarOptionalReadSubregionsRequestok := localVarOptionals.ReadSubregionsRequest.Value().(ReadSubregionsRequest)
		if !localVarOptionalReadSubregionsRequestok {
			return localVarReturnValue, nil, reportError("readSubregionsRequest should be ReadSubregionsRequest")
		}
		localVarPostBody = &localVarOptionalReadSubregionsRequest
	}
