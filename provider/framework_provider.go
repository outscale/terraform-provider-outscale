		...
		Blocks: map[string]schema.Block{
			"endpoints": schema.SetNestedBlock{
				Validators: []validator.Set{
					setvalidator.ConflictsWith(path.MatchRoot("iaas"), path.MatchRoot("oks")),
				},
		...
		Attributes: map[string]schema.Attribute{
			...
			"x509_cert_path": schema.StringAttribute{
				...
				Validators: []validator.String{
					stringvalidator.ConflictsWith(path.MatchRoot("iaas"), path.MatchRoot("oks")),
				},
			},
			"x509_key_path": schema.StringAttribute{
				Optional:           true,
			...
			"insecure": schema.BoolAttribute{
				...
				Validators: []validator.Bool{
					boolvalidator.ConflictsWith(path.MatchRoot("iaas"), path.MatchRoot("oks")),
				},
			},
		},
	}
