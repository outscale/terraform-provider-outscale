...
data "outscale_net_access_points" "data_net_access_point" {
   filter {
        name     = "net_access_point_ids"
        values   = [outscale_net_access_point.net_access_point_1.net_access_point_id,outscale_net_access_point.net_access_point_2.net_access_point_id]
      }
}
