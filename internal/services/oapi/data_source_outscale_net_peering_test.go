...
func TestAccNet_PeeringconnectionDataSource_basic(t *testing.T) {
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceOutscaleNetPeeringConnectionConfig(oapihelpers.GetAccepterOwnerId()),
				Check: resource.ComposeTestCheckFunc(
					testAccDataSourceOutscaleNetPeeringConnectionCheck("outscale_net_peering.net_peering"),
				),
			},
		},
	})
...
func testAccDataSourceOutscaleNetPeeringConnectionCheck(name string) resource.TestCheckFunc {
...
func testAccDataSourceOutscaleNetPeeringConnectionConfig(accountId string) string {
	return fmt.Sprintf(`
