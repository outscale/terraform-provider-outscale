...
func DataSourceOutscaleLoadBalancerVmsHealRead(ctx context.Context, d *schema.ResourceData, meta any) diag.Diagnostics {
	...
	lbvh := make([]map[string]any, len(*resp.BackendVmHealth))
