...
func TestAccVM_PublicIP_instance(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccOutscalePublicIPInstanceConfig(omi, oapi.TestAccVmType, region, keypair, sgName),
				Check: resource.ComposeTestCheckFunc(
...
func TestAccNet_PublicIP_associated_user_private_ip(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccOutscalePublicIPInstanceConfigAssociated(omi, oapi.TestAccVmType, region, keypair, sgName),
				Check: resource.ComposeTestCheckFunc(
			...
			{
				Config: testAccOutscalePublicIPInstanceConfigAssociatedSwitch(omi, oapi.TestAccVmType, region, keypair, sgName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckOutscalePublicIPExists("outscale_public_ip.bar", &one),
					testAccCheckOutscalePublicIPAttributes(&one),
				),
