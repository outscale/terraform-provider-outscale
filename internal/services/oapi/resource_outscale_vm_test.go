...
func TestAccVM_Basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMConfigBasic(omi, oapi.TestAccVmType, region, keypair, sgName),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "vm_type", oapi.TestAccVmType),
...
func TestAccVM_uefi(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMUefi(omi, oapi.TestAccVmType, region, keypair, sgName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckOutscaleVMExists(resourceName, &server),
					testAccCheckOutscaleVMAttributes(t, &server, omi),
...
func TestAccVM_Behavior_Basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMBehaviorConfigBasic(omi, oapi.TestAccVmType, region, keypair, "high", "stop", sgName),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"outscale_vm.basicr1", "vm_type", oapi.TestAccVmType),
				),
			},
			{
				Config: testAccCheckOutscaleVMBehaviorConfigBasic(omi, oapi.TestAccVmType, region, keypair, "high", "restart", sgName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckOutscaleVMExists("outscale_vm.basicr1", &server),
					testAccCheckOutscaleVMAttributes(t, &server, omi),
					resource.TestCheckResourceAttr(
...
func TestAccVM_importBasic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMConfigImport(omi, oapi.TestAccVmType, region, keypair, sgName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckOutscaleVMExists(resourceName, &server),
					resource.TestCheckResourceAttr(resourceName, "image_id", omi),
					resource.TestCheckResourceAttr(resourceName, "vm_type", oapi.TestAccVmType),
...
func TestAccNet_VM_withNicAttached(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMConfigBasicWithNicAttached(omi, oapi.TestAccVmType, utils.GetRegion(), keypair, sgName1, sgName2),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "image_id", omi),
					resource.TestCheckResourceAttr(resourceName, "vm_type", oapi.TestAccVmType),
				),
...
func TestAccVM_withTags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVmsConfigUpdateOAPIVMTags(omi, oapi.TestAccVmType, utils.GetRegion(), tagsValue, keypair, sgName),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"outscale_vm.basic_tags", "vm_type", oapi.TestAccVmType),
				),
			},
		},
	})
...
func TestAccNet_VM_withNics(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMConfigBasicWithNics(omi, oapi.TestAccVmType, keypair, utils.GetRegion(), sgName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "image_id", omi),
					resource.TestCheckResourceAttr(resourceName, "vm_type", oapi.TestAccVmType),
				),
...
func TestAccVM_UpdateKeypair(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVmsConfigUpdateOAPIVMKey(omi, oapi.TestAccVmType, region, generatedKeypair, sgName),
				Check: resource.ComposeTestCheckFunc(
			...
			{
				Config: testAccVmsConfigUpdateOAPIVMKey2(omi, oapi.TestAccVmType, region, generatedKeypair, existingKeypair, sgName),
				Check: resource.ComposeTestCheckFunc(
...
func TestAccNet_VM_WithSubnet(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMConfigWithSubnet(omi, oapi.TestAccVmType, utils.GetRegion(), keypair, sgName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "image_id", omi),
					resource.TestCheckResourceAttr(resourceName, "vm_type", oapi.TestAccVmType),
				),
...
func TestAccVM_UpdateTags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccVmsConfigUpdateOAPIVMTags(omi, oapi.TestAccVmType, utils.GetRegion(), "Terraform-VM2", keypair, sgName),
				// Check:  resource.ComposeTestCheckFunc(),
			},
		},
	})
...
func TestAccVM_multiBlockDeviceMapping(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMWithMultiBlockDeviceMapping(utils.GetRegion(), omi, keypair, oapi.TestAccVmType, sgName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "image_id", omi),
					resource.TestCheckResourceAttr(resourceName, "vm_type", oapi.TestAccVmType),
			...
			{
				Config: testAccCheckOutscaleVMWithMultiBlockDeviceMappingUpdate(utils.GetRegion(), omi, keypair, oapi.TestAccVmType, sgName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrWith(resourceName, "vm_id", func(value string) error {
						if value != vmID {
