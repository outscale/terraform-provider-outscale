...
func TestAccVM_Basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMConfigBasic(omi, testAccVmType, region, keypair, sgName),
...
func TestAccVM_uefi(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMUefi(omi, testAccVmType, region, keypair, sgName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckOutscaleVMExists(resourceName, &server),
					testAccCheckOutscaleVMAttributes(t, &server, omi),
...
func TestAccVM_Behavior_Basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMBehaviorConfigBasic(omi, testAccVmType, region, keypair, "high", "stop", sgName),
				Check: resource.ComposeTestCheckFunc(
			...
			{
				Config: testAccCheckOutscaleVMBehaviorConfigBasic(omi, testAccVmType, region, keypair, "high", "restart", sgName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckOutscaleVMExists("outscale_vm.basicr1", &server),
					testAccCheckOutscaleVMAttributes(t, &server, omi),
					resource.TestCheckResourceAttr(
...
func TestAccVM_importBasic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMConfigImport(omi, testAccVmType, region, keypair, sgName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckOutscaleVMExists(resourceName, &server),
					resource.TestCheckResourceAttr(resourceName, "image_id", omi),
					resource.TestCheckResourceAttr(resourceName, "vm_type", testAccVmType),
...
func TestAccNet_VM_withNicAttached(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMConfigBasicWithNicAttached(omi, testAccVmType, utils.GetRegion(), keypair, sgName1, sgName2),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "image_id", omi),
					resource.TestCheckResourceAttr(resourceName, "vm_type", testAccVmType),
				),
...
func TestAccNet_VM_withNics(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMConfigBasicWithNics(omi, testAccVmType, keypair, utils.GetRegion(), sgName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "image_id", omi),
					resource.TestCheckResourceAttr(resourceName, "vm_type", testAccVmType),
				),
...
func TestAccVM_UpdateKeypair(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVmsConfigUpdateOAPIVMKey(omi, testAccVmType, region, generatedKeypair, sgName),
				Check: resource.ComposeTestCheckFunc(
...
func TestAccNet_VM_WithSubnet(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMConfigWithSubnet(omi, testAccVmType, utils.GetRegion(), keypair, sgName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "image_id", omi),
					resource.TestCheckResourceAttr(resourceName, "vm_type", testAccVmType),
				),
...
func TestAccVM_multiBlockDeviceMapping(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckOutscaleVMWithMultiBlockDeviceMapping(utils.GetRegion(), omi, keypair, testAccVmType, sgName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "image_id", omi),
					resource.TestCheckResourceAttr(resourceName, "vm_type", testAccVmType),
