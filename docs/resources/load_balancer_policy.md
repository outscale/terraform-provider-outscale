...
sidebar_current: "docs-outscale-resource-load-balancer-policy"
description: |-
...
For more information on this resource actions, see the [API documentation](https://docs-beta.outscale.com/#3ds-outscale-api-loadbalancerpolicy).
